      ...
      <div className="body-container">
        ...
        <div>
          <div className="btn-wrapper">
            <button className="img-wrapper" onClick={handleAllChecked}>
