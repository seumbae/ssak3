  ...
  return (
    <div className={`${styles.body_relative} ${styles.flex}`}>
      <div className="body-container">
        ...
        <div className={styles.title}>돈기브업서비스 가입을 시작합니다</div>
        <div>
          <div className={styles.btn_wrapper}>
            ...
            <div className={styles.sub_title}>약관 전체동의</div>
          </div>
          <HorizonLine />
          {/* 가로줄 */}
          <div className={styles.btn_wrapper}>
            ...
            <div className={styles.contents}>돈기브업서비스 이용약관[필수]</div>
          </div>
          <div className={styles.btn_wrapper}>
            ...
            <div className={styles.contents}>마이데이터 관련 사용 동의서[필수]</div>
          </div>
          <div className={styles.btn_wrapper}>
            ...
            <div className={styles.contents}>돈기브업서비스 설명서[필수]</div>
          </div>
        </div>
      </div>
      {isAllChecked() ? (
